...
if (isset($_POST['submit'])) {
 ...
 $result = email_duplicate_check($email);
    ...
    $query .="(userName,passWord,address,mobileNumber,emailAddress,verify,company,company_logo,account_type,code) VALUES ";
    $query .="('{$user}','{$pass}','{$address}','{$contact}','{$email}','notverified','{$company}','{$location}','company','{$code}')";
...
<div class="testbox">
  ...
  <form action="create_company.php" method="post" enctype="multipart/form-data">
    ...
    <div class="accounttype">
      ...
      <label for="radioOne" class="radio" checked>Company</label>
  ...
  <label id="icon" for="name"><i class="icon-shield"></i></label>
  <input type="number" name="contact" id="name" placeholder="Contact Number" required/>
